...
// func Removemacaddress(w http.ResponseWriter, r *http.Request) {
...
// 	cmd := exec.Command("python3", "external_scripts/showcommands/gpon/"+commands.Vendor+"/"+commands.Command+".py", user.DeviceUsername, user.DevicePassword,commands.IpAddress,  commands.MacAddress, commands.VlanId)
