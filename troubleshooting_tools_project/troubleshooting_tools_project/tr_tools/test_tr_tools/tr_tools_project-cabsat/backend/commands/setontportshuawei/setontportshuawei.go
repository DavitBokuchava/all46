...
func SetOntPortsHuaweiGPON(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Println(user.DeviceUsername, user.DevicePassword, commands.IpAddress, commands.Frame, commands.Slot, commands.Port, commands.Vport, commands.ServiceProfileHuawei, "user.DeviceUsername, user.DevicePassword, commands.IpAddress, commands.Frame, commands.Slot, commands.Port, commands.Vport, commands.ServiceProfileHuawei,    IN SET SERVICE PROFILE ONT PORT COMMAND HUAWEI ")
	// +commands.Technology+"/" //user.DevicePassword, commands.IpAddress, +++
	cmd := exec.Command("python3", "external_scripts/showcommands/gpon/"+commands.Vendor+"/"+commands.Command+".py", user.DeviceUsername, user.DevicePassword, commands.IpAddress, commands.Frame, commands.Slot, commands.Port, commands.Vport, commands.ServiceProfileHuawei)
