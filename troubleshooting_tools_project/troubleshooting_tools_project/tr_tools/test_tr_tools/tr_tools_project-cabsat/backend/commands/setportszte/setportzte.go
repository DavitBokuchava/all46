...
func SetPortsZteGPON(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Println(user.DeviceUsername, user.DevicePassword, commands.IpAddress, commands.Frame, commands.Slot, commands.Port, commands.Vport, commands.ServiceProfileZte, commands.ServicePortLanZte, "  ==== user.DeviceUsername, user.DevicePassword, commands.IpAddress, commands.Frame, commands.Slot, commands.Port, commands.Vport, commands.ServiceProfileZte, commands.ServicePortLanZte,  SET SERVISE PROFILE COMMAND IN ZTE")
	// +commands.Technology+"/" //user.DevicePassword, commands.IpAddress, +++
	cmd := exec.Command("python3", "external_scripts/showcommands/gpon/"+commands.Vendor+"/"+commands.Command+".py", user.DeviceUsername, user.DevicePassword, commands.IpAddress, commands.Frame, commands.Slot, commands.Port, commands.Vport, commands.ServiceProfileZte, commands.ServicePortLanZte)
