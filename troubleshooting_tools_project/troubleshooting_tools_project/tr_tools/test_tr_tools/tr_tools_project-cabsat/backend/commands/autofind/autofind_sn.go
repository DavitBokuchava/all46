...
func Autofind_sn(w http.ResponseWriter, r *http.Request) {
	...
	if commands.Slot == "" || commands.Vport == "" || commands.Port == "" || commands.Vendor == "" || commands.Frame == "" || commands.IpAddress == "" || commands.Command == "" || commands.Position == "" || commands.CustomerId == "" || commands.Technology == "" || commands.Sn == "" || commands.ZoneDeviceList == "" {
	...
	cmd := exec.Command("python3", "external_scripts/showcommands/gpon/"+commands.Command+".py", user.DeviceUsername, user.DevicePassword, commands.ZoneDeviceList, commands.Sn)
