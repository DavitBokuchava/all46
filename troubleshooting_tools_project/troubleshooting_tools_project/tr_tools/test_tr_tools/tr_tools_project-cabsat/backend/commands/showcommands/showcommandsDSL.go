...
func ShowCommandsDSL(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Println(commands, "commandscommandscommandscommands")
	if err1 != nil {
	...
	fmt.Println(err1, commands, "#### err1 commands in DSL")
	if commands.Slot == "" || commands.Port == "" || commands.Vendor == "" || commands.Frame == "" || commands.IpAddress == "" || commands.Command == "" || commands.Position == "" || commands.CustomerId == "" || commands.Technology == "" {
	...
	// +commands.Technology+"/"
	cmd := exec.Command("python3", "external_scripts/showcommands/dsl/"+commands.Vendor+"/"+commands.Command+".py", commands.IpAddress, commands.Frame, commands.Slot, commands.Port)
