...
func ShowCommandsGPON(w http.ResponseWriter, r *http.Request) {
	...
	if commands.Slot == "" || commands.Vport == "" || commands.Port == "" || commands.Vendor == "" || commands.Frame == "" || commands.IpAddress == "" || commands.Command == "" || commands.Position == "" || commands.CustomerId == "" || commands.Technology == "" {
	...
	fmt.Println(commands.SessionId, user.DeviceUsername, user.DevicePassword, commands.IpAddress, commands.Frame, commands.Slot, commands.Port, commands.Vport, user.DeviceUsername, user.DevicePassword, commands.IpAddress, commands.Frame, commands.Slot, commands.Port, commands.Vport, "user.DeviceUsername, user.DevicePassword, commands.IpAddress, commands.Frame, commands.Slot, commands.Port, commands.Vportuser.DeviceUsername, user.DevicePassword, commands.IpAddress, commands.Frame, commands.Slot, commands.Port, commands.Vport")
	// +commands.Technology+"/" //user.DevicePassword, commands.IpAddress, +++
	cmd := exec.Command("python3", "external_scripts/showcommands/gpon/"+commands.Vendor+"/"+commands.Command+".py", user.DeviceUsername, user.DevicePassword, commands.IpAddress, commands.Frame, commands.Slot, commands.Port, commands.Vport)
